            ...
            <section>
              ...
              <div className="form-grid">
                {([
                  ...
                  ["stop_loss_tier_mark_low", "SL mark low", false],
                  ["stop_loss_tier_mark_high", "SL mark high", false],
                  ["min_lead_over_runner_up", "Competition lead gap (normal buy)", false],
                  ["min_lead_momentum_over_runner_up", "Competition lead gap (momentum buy)", false],
              ...
              <div className="form-grid" style={{ marginTop: "0.5rem" }}>
                {([
                  ...
                  ["stop_loss_use_entry_tiers", "SL entry tiers"],
