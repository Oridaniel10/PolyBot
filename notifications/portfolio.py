...
from config.constants import REPORT_HOURS
...
def send_portfolio_telegram(
    ...
    *,
    ...
    telegram.send_html_chunks(build_full_portfolio_html(client, title_h))
...
def send_hourly_summary_report(
    ...
    send_portfolio_telegram(
        telegram, client, headline, headline_html=hh, echo_terminal=False
    )
